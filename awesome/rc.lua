...
globalkeys = mytable.join(
    ...
    awful.key ({modkey,          },"p", function() awful.spawn(screenshot) end,
              {description = "take a screenshot", group = "hotkeys"}),
    awful.key ({modkey,          },"g", function() awful.spawn(gif) end,
              {description = "make a gif", group = "hotkeys"}),
    awful.key ({modkey,          },"d", function() awful.spawn(discord) end,
              {description = "open discord", group = "hotkeys"}),
-- X screen locker
...
awful.spawn.with_shell("~/.screenlayout/two.sh")
-- }}}
