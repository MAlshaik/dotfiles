...
theme.fg_focus                                  = "#d37d61"
theme.fg_urgent                                 = "#C83F11"
theme.bg_normal                                 = "#222222"
theme.bg_focus                                  = "#1E2320"
theme.bg_urgent                                 = "#3F3F3F"
theme.taglist_fg_focus                          = "#d37d61"
theme.tasklist_bg_focus                         = "#222222"
theme.tasklist_fg_focus                         = "#02CCFF"
...
task:buttons(my_table.join(awful.button({}, 3, lain.widget.contrib.task.prompt)))
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --[[ using shapes
            pl(wibox.widget { mpdicon, theme.mpd.widget, layout = wibox.layout.align.horizontal }, "#343435"),
            pl(task, "#343434"),
